...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Tutorial: Complement on GDB &#8212; Exercises 2022 documentation</title>
    ...
    <link rel="next" title="Tutorial: Handmade Shellcode" href="handmadeshellcode.html" />
    <link rel="prev" title="Setting up the lab environment" href="extra.html" />
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Tutorial: Complement on GDB</a><ul>
...
<li><a class="reference internal" href="#">Tutorial: Complement on GDB</a><ul>
<li><a class="reference internal" href="#introduction">Introduction</a></li>
<li><a class="reference internal" href="#exercise">Exercise</a><ul>
<li><a class="reference internal" href="#complement-on-register">Complement on register</a></li>
<li><a class="reference internal" href="#complement-on-gdb">Complement on <code class="docutils literal notranslate"><span class="pre">gdb</span></code></a></li>
</ul>
</li>
</ul>
</li>
...
<g>
  ...
  <div class="section" id="tutorial-complement-on-gdb">
<h1>Tutorial: Complement on GDB<a class="headerlink" href="#tutorial-complement-on-gdb" title="Permalink to this headline">¶</a></h1>
<div class="section" id="introduction">
<h2>Introduction<a class="headerlink" href="#introduction" title="Permalink to this headline">¶</a></h2>
<p>You can use whatever VM you want, just download the file and compile
with:</p>
<ul class="simple">
...
<p>We also disable randomization of the memory in the admin session:</p>
...
<div class="line">This tutorial aims at help you to familiarize more with the <code class="docutils literal notranslate"><span class="pre">gdb</span></code>
tools which is very important to master. It is based on the excellent
book “Hacking: The Art Of exploitation, 2nd” by Jon Erickson.</div>
</div>
<div class="section" id="complement-on-register">
<h3>Complement on register<a class="headerlink" href="#complement-on-register" title="Permalink to this headline">¶</a></h3>
<div class="line-block">
<div class="line">Some notion on the register such that you understand more when and why
they are used in the case of x86 architecture.</div>
<div class="line">The first four registers are known as general purpose registers:</div>
</div>
<ol class="arabic simple">
<li><code class="docutils literal notranslate"><span class="pre">EAX</span></code>: Accumulator</li>
<li><code class="docutils literal notranslate"><span class="pre">ECX</span></code>: Counter</li>
<li><code class="docutils literal notranslate"><span class="pre">EDX</span></code>: Data</li>
<li><code class="docutils literal notranslate"><span class="pre">EBX</span></code>: Base</li>
</ol>
<div class="line-block">
<div class="line">They are used for a variety of purposes, but they mainly act as
temporary variables for the CPU when it is executing machine
instructions.</div>
<div class="line">Then we have the pointers and indexes registers:</div>
</div>
<ol class="arabic simple">
<li><code class="docutils literal notranslate"><span class="pre">ESP</span></code>: Stack Pointer</li>
<li><code class="docutils literal notranslate"><span class="pre">EBP</span></code>: Base Pointer</li>
<li><code class="docutils literal notranslate"><span class="pre">ESI</span></code>: Source Index</li>
<li><code class="docutils literal notranslate"><span class="pre">EDI</span></code>: Destination Index</li>
</ol>
<div class="line-block">
<div class="line">The first two registers are called pointers because they store 32-bit
...
of as just simple general-purpose registers.</div>
</div>
<div class="line-block">
<div class="line">Finally the <code class="docutils literal notranslate"><span class="pre">EIP</span></code> register is the Instruction Pointer register, which
...
instruction using the <code class="docutils literal notranslate"><span class="pre">EIP</span></code> register as its finger.</div>
</div>
</div>
<div class="section" id="complement-on-gdb">
<h3>Complement on <code class="docutils literal notranslate"><span class="pre">gdb</span></code><a class="headerlink" href="#complement-on-gdb" title="Permalink to this headline">¶</a></h3>
<p>First, you have probably remark that the basic version of <code class="docutils literal notranslate"><span class="pre">gdb</span></code> use
...
<code class="docutils literal notranslate"><span class="pre">set</span> <span class="pre">disassembly</span> <span class="pre">intel</span></code></div>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>(gdb) disass main
...
<div class="line-block">
<div class="line">As note, <code class="docutils literal notranslate"><span class="pre">DWORD</span> <span class="pre">PTR</span> <span class="pre">[ecx-0x4]</span></code> simply mean that use the value
located at <code class="docutils literal notranslate"><span class="pre">ECX</span> <span class="pre">-</span> <span class="pre">0x4</span></code>.</div>
<div class="line">We can have information about the registers of a running program with
the command:</div>
</div>
<div class="center docutils container">
<code class="docutils literal notranslate"><span class="pre">info</span> <span class="pre">registers</span></code></div>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span><span class="p">(</span><span class="n">gdb</span><span class="p">)</span> <span class="n">b</span> <span class="o">*</span><span class="mh">0x004011c9</span>
<span class="n">Breakpoint</span> <span class="mi">1</span> <span class="n">at</span> <span class="mh">0x4011c9</span><span class="p">:</span> <span class="n">file</span> <span class="n">program</span><span class="o">.</span><span class="n">c</span><span class="p">,</span> <span class="n">line</span> <span class="mf">7.</span>
<span class="p">(</span><span class="n">gdb</span><span class="p">)</span> <span class="n">r</span>
<span class="n">Starting</span> <span class="n">program</span><span class="p">:</span> <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">user</span><span class="o">/</span><span class="n">SecurityClass</span><span class="o">/</span><span class="n">GDB</span><span class="o">-</span><span class="n">complement</span><span class="o">/</span><span class="n">program</span>

<span class="n">Breakpoint</span> <span class="mi">1</span><span class="p">,</span> <span class="mh">0x004011c9</span> <span class="ow">in</span> <span class="n">main</span> <span class="p">()</span> <span class="n">at</span> <span class="n">program</span><span class="o">.</span><span class="n">c</span><span class="p">:</span><span class="mi">7</span>
<span class="mi">7</span>           <span class="n">puts</span><span class="p">(</span><span class="s2">&quot;Hello, world!</span><span class="se">\n</span><span class="s2">&quot;</span><span class="p">);</span> <span class="o">//</span> <span class="n">put</span> <span class="n">the</span> <span class="n">string</span> <span class="n">to</span> <span class="n">the</span> <span class="n">output</span><span class="o">.</span>
<span class="p">(</span><span class="n">gdb</span><span class="p">)</span> <span class="n">i</span> <span class="n">registers</span>
<span class="n">eax</span>            <span class="mh">0x402008</span>            <span class="mi">4202504</span>
<span class="n">ecx</span>            <span class="mh">0xbffff320</span>          <span class="o">-</span><span class="mi">1073745120</span>
<span class="n">edx</span>            <span class="mh">0xbffff344</span>          <span class="o">-</span><span class="mi">1073745084</span>
<span class="n">ebx</span>            <span class="mh">0x404000</span>            <span class="mi">4210688</span>
<span class="n">esp</span>            <span class="mh">0xbffff2e0</span>          <span class="mh">0xbffff2e0</span>
<span class="n">ebp</span>            <span class="mh">0xbffff308</span>          <span class="mh">0xbffff308</span>
<span class="n">esi</span>            <span class="mh">0xb7fb8000</span>          <span class="o">-</span><span class="mi">1208254464</span>
<span class="n">edi</span>            <span class="mh">0xb7fb8000</span>          <span class="o">-</span><span class="mi">1208254464</span>
<span class="n">eip</span>            <span class="mh">0x4011c9</span>            <span class="mh">0x4011c9</span> <span class="o">&lt;</span><span class="n">main</span><span class="o">+</span><span class="mi">48</span><span class="o">&gt;</span>
<span class="n">eflags</span>         <span class="mh">0x296</span>               <span class="p">[</span> <span class="n">PF</span> <span class="n">AF</span> <span class="n">SF</span> <span class="n">IF</span> <span class="p">]</span>
...
<p>You can also display information in many ways, lets check that with:</p>
<ul>
<li><p class="first"><code class="docutils literal notranslate"><span class="pre">o</span></code> in octal</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span><span class="p">(</span><span class="n">gdb</span><span class="p">)</span> <span class="n">x</span><span class="o">/</span><span class="n">o</span> <span class="mh">0x4011c9</span>
<span class="mh">0x4011c9</span> <span class="o">&lt;</span><span class="n">main</span><span class="o">+</span><span class="mi">48</span><span class="o">&gt;</span><span class="p">:</span>     <span class="mi">037777461350</span>
</pre></div>
</div>
</li>
<li><p class="first"><code class="docutils literal notranslate"><span class="pre">h</span></code> in hexadecimal</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span><span class="p">(</span><span class="n">gdb</span><span class="p">)</span> <span class="n">x</span><span class="o">/</span><span class="n">h</span> <span class="mh">0x4011c9</span>
<span class="mh">0x4011c9</span> <span class="o">&lt;</span><span class="n">main</span><span class="o">+</span><span class="mi">48</span><span class="o">&gt;</span><span class="p">:</span>     <span class="mh">0x62e8</span>
</pre></div>
</div>
</li>
<li><p class="first"><code class="docutils literal notranslate"><span class="pre">u</span></code> in unsigned</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>(gdb) x/u $eip
0x4011c9 &lt;main+48&gt;:     232
</pre></div>
</div>
</li>
<li><p class="first"><code class="docutils literal notranslate"><span class="pre">t</span></code> in binary</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>(gdb) x/t $eip
0x4011c9 &lt;main+48&gt;:     11101000
</pre></div>
</div>
</li>
<li><p class="first">A number can also be prepended to the format of the examine command
to examine multiple units at the target address</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>(gdb) x/h $eip
...
<p>You might also need to know that the default size for a <em>word</em> in x86/32
bits architecture is 4 bytes. We can also tell to <code class="docutils literal notranslate"><span class="pre">gdb</span></code> the default
size of words that we want to display. Don’t forget the little-endian
convention:</p>
<ul>
<li><p class="first"><code class="docutils literal notranslate"><span class="pre">b</span></code> single byte</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>(gdb) x/2bx $eip
0x4011c9 &lt;main+48&gt;:     0xe8    0x62
</pre></div>
</div>
</li>
<li><p class="first"><code class="docutils literal notranslate"><span class="pre">h</span></code> a halfword of 2 bytes</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>(gdb) x/2hx $eip
0x4011c9 &lt;main+48&gt;:     0x62e8  0xfffe
</pre></div>
</div>
</li>
<li><p class="first"><code class="docutils literal notranslate"><span class="pre">w</span></code> a word of 4 bytes, DWORD even if meaning “double word” refer to
a 4 bytes value.</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>gdb) x/2wx $eip
0x4011c9 &lt;main+48&gt;:     0xfffe62e8      0x10c483ff
</pre></div>
</div>
</li>
<li><p class="first"><code class="docutils literal notranslate"><span class="pre">g</span></code> a giant word of 8 bytes</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>(gdb) x/2gx $eip
...
<div class="line-block">
<div class="line">You notice that gdb take care of the order alone and display them in
the correct order.</div>
<div class="line">Another interesting thing to know is that you can also print
“instruction” directly with the <code class="docutils literal notranslate"><span class="pre">i</span></code> option. This can be useful for
<code class="docutils literal notranslate"><span class="pre">EIP</span></code> for example:</div>
</div>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>(gdb) x/i $eip
...
<p>Let’s move to the next instruction with <code class="docutils literal notranslate"><span class="pre">nexti</span></code>:</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>(gdb) b* 0x004011c8
(gdb) c
...
<p>As a last things, sometimes you can find some very interesting
information in the code. For example here take the instruction:</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span><span class="mh">0x004011c2</span> <span class="o">&lt;+</span><span class="mi">41</span><span class="o">&gt;</span><span class="p">:</span>    <span class="n">lea</span>    <span class="n">eax</span><span class="p">,[</span><span class="n">ebx</span><span class="o">-</span><span class="mh">0x1ff8</span><span class="p">]</span> <span class="c1">#load content of [ebx-0x1ff8] in eax</span>
</pre></div>
</div>
<p>We know that the result of a <code class="docutils literal notranslate"><span class="pre">printf</span></code> is store in <code class="docutils literal notranslate"><span class="pre">EAX</span></code>. So by
inspecting <code class="docutils literal notranslate"><span class="pre">ebx-0x1ff8</span></code> we should be able to see what is print.</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>(gdb) x/2xw $ebx - 0x1ff8
...
<p>Does these value means something for you ? Try to think about ASCII
encoding. Let try with <code class="docutils literal notranslate"><span class="pre">gdb</span></code>:</p>
<div class="code bash highlight-default notranslate"><div class="highlight"><pre><span></span>(gdb) x/s $ebx - 0x1ff8
0x402008:       &quot;Hello, world!&quot;
</pre></div>
</div>
<p>As you has seen, <code class="docutils literal notranslate"><span class="pre">gdb</span></code> is very versatile and we can do lot of things
with this tools. Hoping that you will try by yourself to play with.</p>
</div>
</div>
</div>
