...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Setting up the lab environment &#8212; Exercises 2022 documentation</title>
    ...
    <link rel="next" title="Tutorial: Complement on GDB" href="gdb.html" />
    <link rel="prev" title="Tutorial 9: Dynamic Analysis" href="../tp9/tp.html" />
...
<ul class="current">
<li class="toctree-l1 current"><a class="current reference internal" href="#">Setting up the lab environment</a><ul>
<li class="toctree-l2"><a class="reference internal" href="#download-a-vm-manager">Download a VM manager</a></li>
<li class="toctree-l2"><a class="reference internal" href="#grab-your-kali-linux-image">Grab your Kali Linux Image</a></li>
<li class="toctree-l2"><a class="reference internal" href="#bonus-make-yourself-at-home">Bonus : Make yourself at home !</a></li>
</ul>
</li>
...
<li><a class="reference internal" href="#">Setting up the lab environment</a><ul>
<li><a class="reference internal" href="#download-a-vm-manager">Download a VM manager</a></li>
<li><a class="reference internal" href="#grab-your-kali-linux-image">Grab your Kali Linux Image</a><ul>
<li><a class="reference internal" href="#get-your-running-image-all-set-up">Get your running image all set up</a></li>
<li><a class="reference internal" href="#setup-your-vm-by-yourself">Setup your VM by yourself</a></li>
</ul>
</li>
<li><a class="reference internal" href="#bonus-make-yourself-at-home">Bonus : Make yourself at home !</a></li>
</ul>
</li>
</ul>
...
<g>
  ...
  <div class="section" id="setting-up-the-lab-environment">
<h1>Setting up the lab environment<a class="headerlink" href="#setting-up-the-lab-environment" title="Permalink to this headline">¶</a></h1>
<p>For this course we won’t be using our own private machine in order to
protect us from undesired behaviours. We will be using a Virtual
environment designed specifically for hackers : <a class="reference external" href="https://www.kali.org/">Kali Linux</a></p>
<p>We might need another Virtual Machine that we will call
<a class="reference external" href="https://docs.rapid7.com/metasploit/metasploitable-2/">Metasploitable</a> that is designed with a lot of common vulnerabilities
that we will be exploiting.</p>
<p><strong>Why have two machines ?</strong> We will see some exploit that requires a
running server with specific port opened and Metasploitable has it all
setup already and in a isolated environment nontheless.</p>
<div class="section" id="download-a-vm-manager">
<h2>Download a VM manager<a class="headerlink" href="#download-a-vm-manager" title="Permalink to this headline">¶</a></h2>
<p>You can chose the one you want : <a class="reference external" href="https://www.virtualbox.org/wiki/Downloads">VirtualBox</a> or <a class="reference external" href="https://www.vmware.com/products/workstation-player/workstation-player-evaluation.html">VMWare</a></p>
<p>For this tutorial I will be using VirtualBox as an example.</p>
</div>
<hr class="docutils" />
<div class="section" id="grab-your-kali-linux-image">
<h2>Grab your Kali Linux Image<a class="headerlink" href="#grab-your-kali-linux-image" title="Permalink to this headline">¶</a></h2>
<p>We give you two possibilities to get a running image with all the lab
materials. You can either <a class="reference external" href="#get-your-running-image-all-set-up">download an already set up image</a> <strong>or</strong>
<a class="reference external" href="#setup-your-vm-by-yourself">grab an image from the official Kali Linux website and set it up
yourself</a></p>
<p>I suggest you try to set up your VM yourself following the guide below
so you will be able to set up any VM in the future.</p>
<div class="section" id="get-your-running-image-all-set-up">
<h3>Get your running image all set up<a class="headerlink" href="#get-your-running-image-all-set-up" title="Permalink to this headline">¶</a></h3>
<p>You can download the image <a class="reference external" href="/">right here</a>.</p>
<p>Once it’s downloaded you can import it via your VM manager (there should
be an import button that will setup everything for you).</p>
<p>When the installation is done try to connect with the following
creditentials :</p>
<ul class="simple">
<li>user : kali</li>
<li>pwd : kali</li>
</ul>
<p><em>(The keyboard is in US-en layout)</em></p>
</div>
<hr class="docutils" />
<div class="section" id="setup-your-vm-by-yourself">
<h3>Setup your VM by yourself<a class="headerlink" href="#setup-your-vm-by-yourself" title="Permalink to this headline">¶</a></h3>
<p>Download the Kali Linux 2020.2  (32-bit) image on the <a class="reference external" href="https://www.offensive-security.com/kali-linux-vm-vmware-virtualbox-image-download/#1572305786534-030ce714-cc3b">official offensive security
website</a>. Be sure to select the correct image depending on what VM
Manager you installed (VirtualBox or VMWare).</p>
<p>Open VirtualBox and click on the big blue <strong>New</strong> button.</p>
<p>You can chose the name and the location of your VM as well as the OS.
Chose Linux and select the Debian 32-bit version. You can keep the
default amount of RAM allocated to the VM.</p>
<p>You will then need to link the image you downloaded. To that on the next
screen select <em>Use an existing virtual hard disk drive</em> and click on the
folder icon on the right. You will then need to add the new virtual disk
by clicking <em>Add</em>.</p>
<p>Find where your image is and select it.</p>
<p>Create.</p>
<p>Done !</p>
<p>Try to run it and log in using the following creditentials :</p>
...
<div class="section" id="bonus-make-yourself-at-home">
<span id="id1"></span><h2>Bonus : Make yourself at home !<a class="headerlink" href="#bonus-make-yourself-at-home" title="Permalink to this headline">¶</a></h2>
<p>The VM is not really appealing as it is so I would suggest you set up an
SSH connection so you can work easily via your terminal.</p>
<p>You will also surely need to pull/push github content on a private repo
and if like me you’re using a password manager there is a lot of chance that you
don’t know your password so be sure to set-up the ssh authentication via your github account.</p>
</div>
</div>
