...
def html_add_content(app, doctree, docname):
	...
	#text = u'<div id="results" style="display: none;"></div><input type="submit" value="' + translations[language]['verify'] + '" id="submit" />'
	...
	# text += '<button type="submit" class="btn btn-primary" id="submit">' + translations[language][
	# 	'verify'] + '</button>'
	text += u'<button type="submit" class="btn btn-primary" id="submit">' + translations[language][
		'verify'] + '</button>'
