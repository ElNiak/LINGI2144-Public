...
Buffer overflow and shellcode work because of 3 actions:

#. one can execute instruction on the stack

#. one can smash the stack

#. one know the address of the shell code

This is a memory corruption issue but it is hard to detect due to
the limits of softbound, tripwire, ...
